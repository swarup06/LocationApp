...
export class LocationComponent implements OnInit {
  ...
  constructor(private service: LocationService,private formBuilder: FormBuilder) { }
  ...
  getLocation(){
    this.spinner=true;
    this.service.getLocationDetails(this.locationForm.controls.locationName.value).subscribe(data => {
      this.httpData=data;
